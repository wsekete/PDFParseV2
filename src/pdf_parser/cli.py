...
@click.option('--confidence-threshold', '-c', default=0.8, help='Confidence threshold for auto-apply')
@click.option('--preview-only', '-p', is_flag=True, help='Preview names without applying')
